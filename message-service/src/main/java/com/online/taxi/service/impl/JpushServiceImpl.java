...
public class JpushServiceImpl implements JpushService {
    ...
    @NonNull
    private final PushMessageRecordDao pushMessageRecordDao;

    @NonNull
    private final PushAccountDao pushAccountDao;

    @NonNull
    private final MessageShowService messageShowService;
    ...
    private ResponseResult<?> sendSingleMessage(int pushAccountIdentity, String targetPlatform, String jpushId, JpushMessage jpushMessage, int audience, String sendId, Integer sendIdentity) {
        ...
        try {
            ...
            PushPayload pushPayload = buildMessagePushPayLoad(jpushMessage.getTitle(), jpushMessage.getMessageBody(), jpushId, audience);
            if (pushPayload == null) {
    ...
    private PushPayload buildMessagePushPayLoad(String title, String messageContent, String jpushId, int audience) {
