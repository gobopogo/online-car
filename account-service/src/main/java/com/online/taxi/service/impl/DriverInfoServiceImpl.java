...
public class DriverInfoServiceImpl implements DriverInfoService {
    ...
    @NonNull
    private final DriverInfoCacheService driverInfoCacheService;

    @NonNull
    private final DriverLicenceInfoDao driverLicenceInfoDao;

    @NonNull
    private final DriverBaseInfoDao driverBaseInfoDao;
